...
<form method="POST" action="{{ route('categories.update', $category->id) }}" class="ajaxForm">
       ...
       <div class="form-group row">
        ...
        <div class="col-8">
            <input class="form-control" name="name" type="text" id="name" value="{{ $category->name }}" autocomplete="off">
        </div>
    </div>

    <div class="col-sm-8 offset-sm-4 pt-4">
        <button type="submit" data-refresh="true" class="btn green btn-primary">تحديث</button>
